    ...
    while idx < len(all_images):
        ...
        for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
            ...
            for si, pred in enumerate(preds):
                ...
                # Save/log
                if save_txt:
                    save_one_txt(predn, save_conf, shape, file=save_dir / 'labels' / f'{path.stem}_{idx}.txt')
                if save_json:
            ...
            if plots and not production:
                plot_images(im, targets, paths, save_dir / f'{path.stem}_{idx}.jpg', names)  # labels
                plot_images(im, output_to_target(preds), paths, save_dir / f'{path.stem}_pred_{idx}.jpg', names)  # pred
        ...
        if save_json and len(jdict):
            ...
            pred_json = str(save_dir / f'{w}_predictions_{idx}.json')  # predictions
